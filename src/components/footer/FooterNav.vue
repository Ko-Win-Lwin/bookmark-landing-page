<template>
    <nav
            class="flex flex-col lg:flex-row justify-center gap-8 lg:justify-start items-center px-5 lg:px-10 lg:pr-12 py-8">
                <!-- logo -->
        <div class="lg:mr-14">
        ...
        <!-- nav_links -->
        <div
                class="text-slate-200  flex flex-col justify-center items-center
            md:flex md:justify-around md:items-center
            lg:flex-row lg:justify-around lg:items-center gap-8 font-bold">
        ...
        <div class="flex items-center gap-8 lg:gap-5 lg:ml-auto">
            <a href="#">
